...
echo ""
echo "  Evaluation:"
echo "    ilt-eval          — Exp 3: compare baseline vs DS-CNN"
echo "    ilt-generalize    — Exp 4: test on StdMetal/StdContact"
echo "    ilt-analyze       — dataset + results analysis"
echo ""
echo "  Utilities:"
echo "    ilt-verify        — verify all deps are working"
echo "    ilt-validate      — test full pipeline (dry run)"
